...
import './Hero.css'
import pinthero from '../../assets/pinthero.png'
import { FaShipingFast } from 'react-icons/fa'
    ...
    <div>
      ...
      <div className="hero_top">
        ...
        <div className="hero_right">
          <img src={pinthero} alt="" />
        </div>
      </div>
      <div className="hero_bottom">
        <div className="hero_content">
          <div className="info_icon"><FaShipingFast className='hero_icon'/> </div>
          <div className="detail"></div>
            <h3>Free Shipping</h3>
            <p>for all orders on black friday</p>
        </div>
        <div className="hero_content">
